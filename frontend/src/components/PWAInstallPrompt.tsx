...
export function PWAInstallPrompt() {
  ...
  return (
    ...
    >
      <div className="bg-[#05060f]/90 text-white backdrop-blur-xl rounded-2xl p-4 shadow-2xl border border-[rgba(186,215,247,0.16)] flex items-start gap-3">
        <div className="w-8 h-8 rounded-xl bg-[rgba(186,214,247,0.08)] border border-[rgba(186,215,247,0.16)] flex items-center justify-center text-[#b6d9fc] shrink-0 mt-0.5">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2">
            ...
            <button
              ...
              className="rounded-full p-1 text-[#9da7ba] hover:text-white hover:bg-[rgba(186,214,247,0.08)] transition-colors"
              aria-label="Tutup pemberitahuan"
            >
              <X className="h-3.5 w-3.5" />
            </button>
          </div>
          <p className="mt-0.5 text-[11px] text-[#9da7ba] line-clamp-1">
            Akses pengumuman, iuran &amp; agenda lebih cepat langsung dari layar utama HP.
          </p>

          {isIOS ? (
            <p className="mt-1.5 text-[10px] text-[#9da7ba] bg-[rgba(186,214,247,0.04)] rounded px-2 py-1">
            ...
            <div className="mt-2 flex items-center gap-2">
              <button
                ...
                className="apple-btn-primary text-[11px] h-7 px-3 flex items-center gap-1"
              >
                <Download className="h-3 w-3" />
                Pasang di HP
              </button>
              <span className="flex items-center gap-1 text-[10px] text-[#9da7ba]">
                <CheckCircle2 className="h-3 w-3 text-[#b6d9fc]" /> Cepat &amp; hemat kuota
              </span>
            </div>
          )}
        </div>
